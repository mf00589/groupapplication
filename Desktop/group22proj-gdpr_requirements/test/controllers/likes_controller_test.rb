...
class LikesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create like" do
    assert_difference('Like.count') do
      post likes_url, params: { like: { submissionid: @like.submissionid, userid: @like.userid } }
    end
  ...
  test "should update like" do
    patch like_url(@like), params: { like: { submissionid: @like.submissionid, userid: @like.userid } }
